...
public class CoinVerifierTests
{
	...
	public async Task CanHandleBlacklistedUtxosTestAsync()
	{
		...
		coinVerifier.StepRoundVerifiers(GenerateRoundStates(roundId), CancellationToken.None);
